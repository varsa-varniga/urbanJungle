...
document.addEventListener("DOMContentLoaded", function () {
    const plantsButton = document.getElementById('best-picks'); // ID of the Best Picks Plants item
    const bestPicksSection = document.getElementById(''); // ID of Best Picks section
    const plantsSection = document.getElementById('plantsSection'); // ID of Plants section
