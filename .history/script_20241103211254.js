...
window.onload = function() {
    // Initially, hide the air-purifying plants section
    document.getElementById('air-purifying-plants').classList.add('hidden');
    document.getElementById('bonsai-plants').classList.add('hidden');
    document.getElementById('succulent').classList.add('hidden');
    document.getElementById('flower').classList.add('hidden');
    document.getElementById('medicine').classList.add('hidden');
    document.getElementById('Pots and Planters').classList.add('hidden');
...
document.addEventListener("DOMContentLoaded", function () {
    const bestpicksection= document.getElementById("best picks");
    ...
    const bestpickplant = document.getElementById("bestpick plant"); 
    const aboutsec = document.getElementById('aboutsection');
    const bottom=this.document.getElementById('bottom');

    
    bestpickplant.addEventListener("click", function () {
        plantTypesSection.classList.remove("hidden");
        aboutsec.classList.add('hidden');
        heroSection.classList.add("hidden");
        bottom.classList.add('hidden');
        bestpicksection.classList.add('hidden');
    });
});
*/
window.onload = function() {
    // Initially, hide all plant sections
    document.getElementById('plant').classList.add('hidden');
    document.getElementById('Pots and Planters').classList.add('hidden');
    document.getElementById('air-purifying').classList.add('hidden');
    document.getElementById('bonsai').classList.add('hidden');
    document.getElementById('succulents').classList.add('hidden');
    document.getElementById('flowering plants').classList.add('hidden');
    document.getElementById('medicinal plants').classList.add('hidden');
    document.getElementById('ornamental plants').classList.add('hidden');
};
