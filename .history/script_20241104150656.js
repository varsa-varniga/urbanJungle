...
window.onload = function() {
    ...
    document.getElementById('glass-section').classList.add
...
//glass
document.addEventListener("DOMContentLoaded", function (){
    const terracottaSection = document.getElementById('glass-section');
    const terracottaButton = document.getElementById('Fibreglass Planters');
    const terracottaBackButton = document.getElementById('glass-back-button');
