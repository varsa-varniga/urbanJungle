...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!potsbutton || !potsection || !potbackbutton || !bestPicksSection) {
...
// terracotta plants
document.addEventListener("DOMContentLoaded", function () {
    const terracottaSection = document.getElementById");
    const terracottaButton = document.getElementById("bestpick-pots"); 
    const terracottabackButton = medicineSection.querySelector("terracotta-back-button");
