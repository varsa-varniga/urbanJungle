...
const bestPicksSection = document.getElementById('best-picks'); // Ensure this is declared

document.addEventListener("DOMContentLoaded", function () {
    // Handling the Best Picks section
    careButton.addEventListener('click', function () {
        bestPicksSection.classList.add('hidden');  // Hide Best Picks section
        careSection.classList.remove('hidden');     // Show Plant Care section
    });

    careBackButton.addEventListener('click', function () {
        careSection.classList.add('hidden');        // Hide Plant Care section
        bestPicksSection.classList.remove('hidden'); // Show Best Picks section
    });
});
