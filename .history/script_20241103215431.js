...
window.onload = function() {
    ...
    document.getElementById('bonsaiSection').classList.add('hidden');
...
document.addEventListener("DOMContentLoaded", function () {
    const bestPicksSection = document.getElementById("plants");
    const plantsSection = document.getElementById("plantsSection");
    const bonsaiSection = document.getElementById("bonsaiSection");
    const succulentsSection = document.getElementById("succulentsSection");
    const airPurifyingSection = document.getElementById("airPurifyingSection");

    // Best Picks -> Plants
    document.getElementById("plants").addEventListener("click", function () {
    ...
    // Plants -> Succulents
    document.getElementById("succulents").addEventListener("click", function () {
        plantsSection.classList.add("hidden");
        succulentsSection.classList.remove("hidden");
    });

    // Plants -> Air Purifying
    document.getElementById("airPurifying").addEventListener("click", function () {
        plantsSection.classList.add("hidden");
        airPurifyingSection.classList.remove("hidden");
    });

    // Back Buttons
    document.getElementById("bonsaiBackButton").addEventListener("click", function () {
        bonsaiSection.classList.add("hidden");
        plantsSection.classList.remove("hidden");
    });

    document.getElementById("succulentsBackButton").addEventListener("click", function () {
        succulentsSection.classList.add("hidden");
        plantsSection.classList.remove("hidden");
    });

    document.getElementById("airPurifyingBackButton").addEventListener("click", function () {
        airPurifyingSection.classList.add("hidden");
        plantsSection.classList.remove("hidden");
    });

    // Back to Best Picks
    document.getElementById("plantsBackButton").addEventListener("click", function () {
        plantsSection.classList.add("hidden");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const bonsaiButton = document.getElementById("bonsai"); // The Bonsai item in the plant types section
    const backButton = bonsaiSection.querySelector("#back-button");
    const aboutsec = document.getElementById('aboutsection');
