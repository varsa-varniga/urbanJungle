...
// Show plants section and hide best picks
document.getElementById('plants').addEventListener('click', function () {
    document.getElementById('best-picks').classList.add('hidden'); // Hide Best Picks
    document.getElementById('plantsSection').classList.remove('hidden'); // Show Plants
});

// Back button functionality
document.getElementById('plantsBackButton').addEventListener('click', function () {
    document.getElementById('plantsSection').classList.add('hidden'); // Hide Plants
    document.getElementById('best-picks').classList.remove('hidden'); // Show Best Picks
});
