...
//care section
const careButton = document.getElementById('bestpick-pots');
const careBackButton = document.getElementById('potbackbutton');
const careSection = document.getElementById('pot-section');
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    careButton.addEventListener('click', function () {
        bestPicksSection.classList.add('hidden');  // Hide Best Picks section
        careSection.classList.remove('hidden');     // Show Pots section
    });

    careBackButton.addEventListener('click', function () {
        bestPicksSection.classList.remove('hidden');  // Show Best Picks section
        careSection.classList.add('hidden');           // Hide Pots section
    });
});
