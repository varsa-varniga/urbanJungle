...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const terracottabackButton = terracottaSection.querySelector(".terracotta-back-button"); // Corrected

    const potsection = document.getElementById("pot-section"); // Make sure this exists in your HTML
    // const aboutsec = document.getElementById("aboutsec"); // Uncomment if you have an about section
    // const heroSection = document.getElementById("heroSection"); // Uncomment if you have a hero section
