...
const images = [
  ...
  const intervalTime = 2000; // Time in milliseconds for each slide (5000ms = 5s)
...
window.onload = function() {
    ...
    document.getElementById('succulent-section').classList.add('hidden');
    document.getElementById('airpurifying-section').classList.add('hidden');

    document.getElementById('pot-section').classList.add('hidden');
    document.getElementById('care-section').classList.add('hidden');

};
const plantsButton = document.getElementById('bestpick-plants'); // ID of the Best Picks Plants item
 // ID of Best Picks section
const plantsSection = document.getElementById('plant'); // ID of Plants section
...
document.addEventListener("DOMContentLoaded", function (){
    ...
    glassButton.addEventListener('click', function () {
        glassSection.classList.remove('hidden');  // Show Terracotta section
        potSection.classList.add('hidden');            // Hide Pots section
    });

    glassBackButton.addEventListener('click', function () {
        glassSection.classList.add('hidden');     // Hide Terracotta section
        potSection.classList.remove('hidden');         // Show Pots section again
    });
});
...
//wooden
document.addEventListener("DOMContentLoaded", function (){
    const woodenSection = document.getElementById('wooden-section');
    const woodenButton = document.getElementById('Wooden-Planters');
    const woodenBackButton = document.getElementById('wooden-back-button');

    woodenButton.addEventListener('click', function () {
        woodenSection.classList.remove('hidden');  // Show Terracotta section
        potSection.classList.add('hidden');            // Hide Pots section
    });

    woodenBackButton.addEventListener('click', function () {
        woodenSection.classList.add('hidden');     // Hide Terracotta section
        potSection.classList.remove('hidden');         // Show Pots section again
    });
});
...
//hanging pots
document.addEventListener("DOMContentLoaded", function (){
    const hangerSection = document.getElementById('hanging-section');
    const hangerButton = document.getElementById('Hanging Planters');
    const hangerBackButton = document.getElementById('hanging-back-button');

    hangerButton.addEventListener('click', function () {
        hangerSection.classList.remove('hidden');  
        potSection.classList.add('hidden');            
    });

    hangerBackButton.addEventListener('click', function () {
        hangerSection.classList.add('hidden');     
        potSection.classList.remove('hidden');         
    });
});

//Ceramic pots
document.addEventListener("DOMContentLoaded", function (){
    const ceramicSection = document.getElementById('ceramic-section');
    const ceramicButton = document.getElementById('Ceramic-pots');
    const ceramicBackButton = document.getElementById('ceramic-back-button');

    ceramicButton.addEventListener('click', function () {
        ceramicSection.classList.remove('hidden');  
        potSection.classList.add('hidden');            
    });

    ceramicBackButton.addEventListener('click', function () {
        ceramicSection.classList.add('hidden');     
        potSection.classList.remove('hidden');         
    });
});

// Care section
const careButton = document.getElementById('bestpick-care');
const careBackButton = document.getElementById('plantcarebackbutton');
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    careBackButton.addEventListener('click', function () {
