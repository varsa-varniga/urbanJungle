...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const terracottabackButton = terracottaSection.querySelector(".terracotta-back-button");
    const potsection = document.getElementById("potsection"); // Add the correct ID for the pot section
    // const aboutsec = document.getElementById("aboutsec"); // Uncomment if you are using the about section
    // const heroSection = document.getElementById("heroSection"); // Uncomment if you are using the hero section

    terracottaButton.addEventListener("click", function () {
        terracottaSection.classList.remove("hidden");
        potsection.classList.add("hidden");
        // aboutsec.classList.add("hidden");
        // heroSection.classList.add("hidden");
    });
    ...
    terracottabackButton.addEventListener("click", function () {
        terracottaSection.classList.add("hidden");
        potsection.classList.remove("hidden");
        // aboutsec.classList.remove("hidden");
        // if (heroSection) heroSection.classList.remove("hidden");
    });
